...
import BtcImg from "shared/src/assets/imgs/main/Bitcoin.png";
import EthImg from "shared/src/assets/imgs/main/Ethereum.png";
import SushiImg from "shared/src/assets/imgs/main/Sushi.png";
import UsdcImg from "shared/src/assets/imgs/main/usd-coin-usdc-logo.png";
...
export const SUSHILogo = ()=> {
  return (
    <img src={ SushiImg } alt="" />
  )
}

export const USDLogo = ()=> {
  return (
    <img src={ UsdcImg } alt="" />
  )
}